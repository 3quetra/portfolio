...
### 6. Supervised Machine Learning (Ensemble Technique): ["OKCupid Dating App"](./ml/supervised_learning/dating_app_profiles_analysis.ipynb)
...
### 5. NLP: ["Movie Reviews"](./nlp/nlp_portfolio_project.ipynb)
...
### 2. SQL queries (SQLite): ["Marketing Data Analysis"](./sql/marketing_analysis.ipynb)
